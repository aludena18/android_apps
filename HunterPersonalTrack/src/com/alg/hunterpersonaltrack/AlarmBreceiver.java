...
public class AlarmBreceiver extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent) {
		...
		inicioManagerGSM(context);
		inicioManagerGPS(context);
	...
	private void inicioManagerGSM(Context context){
	...
	private void inicioManagerGPS(Context context){
		locationManager = (LocationManager)context.getSystemService(Context.LOCATION_SERVICE);
		locListenerGps = new LocationListenerGps(telManager.getDeviceId(), EVENT_NUMBER);
		locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 10000, 15, locListenerGps);
